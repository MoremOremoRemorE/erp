...
public class MessageUtil {
    private static final Logger bizLogger = LoggerFactory.getLogger(com.erp.util.MessageUtil.class);
    ...
    public static void sendMessageToOriginator(String processInstanceId) throws RuntimeException {
        try {
            ...
            OapiProcessinstanceGetResponse response = client.execute(request, com.erp.util.AccessTokenUtil.getToken());
            ...
            OapiMessageCorpconversationAsyncsendV2Response rsp = client.execute(messageRequest, com.erp.util.AccessTokenUtil.getToken());
