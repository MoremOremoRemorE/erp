 ...
 * 原料销售订单模板
 */
public class MaterialOddInfMsg {

    public static ProcessInstanceInputVO getProcessInstanceInputVOMaterialOddInf(MaterialOddInf materialOddInf) {
